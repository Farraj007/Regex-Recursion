...
function capitalA(s){
    let word = /[A-Za-z]+\s[A-Za-z]+\s[A]/g;
    let test = word.test(s);
    return test;
}
...
function ioEmail(email){
    ...
    let search1 = /\./g;
    let search2 = /@/g;
    let test1 = search.test(email)
    let test2 = email.match(search1)
    let test3 = email.match(search2)
